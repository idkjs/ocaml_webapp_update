...
#+MACRO: gitlab [[https://gitlab.com/shonfeder/ocaml_webapp_update/blob/master/$1][./$1]]
...
#+BEGIN_SRC sh
git clone https://gitlab.com/shonfeder/ocaml_webapp_update
#+END_SRC
...
#+BEGIN_SRC sh
dune init proj ocaml_webapp_update \
    --libs core,opium,caqti,caqti-driver-postgresql,caqti-lwt,tyxml,lwt.unix \
    --ppx ppx_rapper
#+END_SRC

This creates a new directory named =ocaml_webapp_update=, with the following
...
#+BEGIN_SRC sh
opam switch
# →/home/you/path/to/ocaml_webapp_update  ocaml-base-compiler.4.08.1  /home/you/path/to/ocaml_webapp_update
#+END_SRC
...
#+BEGIN_SRC sh
createdb ocaml_webapp_update
# Replace 'ocaml_webapp_update' with your app's name if you're working with custom code
#+END_SRC
...
#+BEGIN_SRC sh
dune exec ocaml_webapp_update -- --help
#+END_SRC
...
- Fork [[https://gitlab.com/shonfeder/ocaml_webapp_update][this repo]] and make a PR to correct or improve something
- [[https://gitlab.com/shonfeder/ocaml_webapp_update/issues][Open an issue]]
...
this tutorial. See https://gitlab.com/shonfeder/ocaml_webapp_update/merge_requests/1
